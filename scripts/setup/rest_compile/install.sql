...
prompt >> Executing db/_setup/rest_compile/rest_compile_logs.sql
-- =====================================================================
-- Begin File: db/_setup/rest_compile/rest_compile_logs.sql
-- =====================================================================
...
-- =====================================================================
-- End File: db/_setup/rest_compile/rest_compile_logs.sql
-- =====================================================================


prompt >> Executing db/_setup/rest_compile/rest_compile.pks
-- =====================================================================
-- Begin File: db/_setup/rest_compile/rest_compile.pks
-- =====================================================================
...
-- =====================================================================
-- End File: db/_setup/rest_compile/rest_compile.pks
-- =====================================================================


prompt >> Executing db/_setup/rest_compile/rest_compile.pkb
-- =====================================================================
-- Begin File: db/_setup/rest_compile/rest_compile.pkb
-- =====================================================================
...
-- =====================================================================
-- End File: db/_setup/rest_compile/rest_compile.pkb
-- =====================================================================


prompt >> Executing db/_setup/rest_compile/com.dbflow.deploy.module.sql
-- =====================================================================
-- Begin File: db/_setup/rest_compile/com.dbflow.deploy.module.sql
-- =====================================================================
...
-- =====================================================================
-- End File: db/_setup/rest_compile/com.dbflow.deploy.module.sql
-- =====================================================================


prompt >> Executing db/_setup/rest_compile/rest_compile_api_role.sql
-- =====================================================================
-- Begin File: db/_setup/rest_compile/rest_compile_api_role.sql
-- =====================================================================
begin
    -- Define role
    ords.create_role(
...
/
-- =====================================================================
-- End File: db/_setup/rest_compile/rest_compile_api_role.sql
-- =====================================================================


prompt >> Executing db/_setup/rest_compile/rest_compile_api_priv.sql
-- =====================================================================
-- Begin File: db/_setup/rest_compile/rest_compile_api_priv.sql
-- =====================================================================
declare
...
/
-- =====================================================================
-- End File: db/_setup/rest_compile/rest_compile_api_priv.sql
-- =====================================================================


prompt >> Executing db/_setup/rest_compile/rest_compile_api_client.sql
-- =====================================================================
-- Begin File: db/_setup/rest_compile/rest_compile_api_client.sql
-- =====================================================================
declare
...
-- =====================================================================
-- End File: db/_setup/rest_compile/rest_compile_api_client.sql
-- =====================================================================
